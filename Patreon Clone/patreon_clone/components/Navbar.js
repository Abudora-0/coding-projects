...
const Navbar = () => {
  ...
  return (
    <nav className='bg=gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16'>
        ...
        <img src='tea.gif' className='invertImg' width={44} alt=''/>
        ...
        <div className='relative flex justify-center items-center md:block gap-4'>
            ...
            }} id='dropdownDefaultButton' data-dropdown-toggle="dropdown" className='text-white mx-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center inline-flex  items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                type='button'>Account
